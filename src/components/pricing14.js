      ...
      <div className="pricing14-max-width thq-section-max-width">
        ...
        <div className="pricing14-tabs">
          {isMonthly && (
            ...
            >
              <span className="thq-body-small">Standard</span>
            </button>
          )}
          {!isMonthly && (
            <button
          ...
          {!isMonthly && (
            ...
            >
              <span className="thq-body-small">Pro</span>
            </button>
          )}
          {isMonthly && (
            <button
            ...
            <div className="pricing14-column1 thq-card">
              ...
              <button className="pricing14-button14 thq-button-outline thq-button-animated">
                <span className="thq-body-small">
                  {props.plan1Action ?? (
                    <Fragment>
                      <span className="pricing14-text158">Enroll Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column2 thq-card">
              ...
              <button className="pricing14-button15 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan2Action ?? (
                    <Fragment>
                      <span className="pricing1-text122">Enroll Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column3 thq-card">
              ...
              <button className="pricing14-button15 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing14-text156">Enroll Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing14-price16">
                ...
                <div className="pricing14-price17">
                  ...
                  <span className="pricing14-text131 thq-body-large">
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing14-text157">Manual Testing Pro</span>
                      </Fragment>
                    )}
                    <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan1Price2 ?? (
                      <Fragment>
                        <span className="pricing14-text193">$499</span>
                      </Fragment>
                    )}
                  </h3>
                  </span>
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text196">$999</span>
                      </Fragment>
                    )}
                  </h3>
