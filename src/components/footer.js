    ...
    <footer className="footer-footer1 thq-section-padding">
      <div className="footer-max-width thq-section-max-width">
        ...
        <div className="footer-credits">
          ...
          <span >Codecraft Academy SRL, <b> Address:</b> of 5 32/2 Andrei Doga, Chisinau, Republic of Moldova. <b>Phone:</b> +1 (800) 290-1358 <b>E-mail:</b> support@code-craft.academy</span>
