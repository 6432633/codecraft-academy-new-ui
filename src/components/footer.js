    ...
    <footer className="footer-footer1 thq-section-padding">
      <div className="footer-max-width thq-section-max-width">
        ...
        <div className="footer-credits">
          ...
          <span style={{fontSize:"11px"}}>Codecraft Academy SRL, <b> Address:</b> of 5 32/2 Andrei Doga, Chisinau, Republic of Moldova. <b>Phone:</b> US: +1 (800) 290-1358 MD: +373 69 207 444 <b>E-mail:</b> support@code-craft.academy</span>
...
Footer.defaultProps = {
  ...
  content3: 'Join our community of software testing enthusiasts.',
  link4: 'Contact Us',
